...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#080C12] border-t border-gray-800 py-8 sm:py-12 mt-12 sm:mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-6 border-t border-gray-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 text-center sm:text-left">
